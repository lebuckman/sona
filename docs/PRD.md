...
- *Why do I keep coming back to certain artists?*
- *What does my music say about my mood patterns?*
- *What do I actually sound like as a listener?*
- *Which of my playlists fits how I'm feeling right now?*
...
- Example: *"Generate me a 1-hour playlist for late-night studying"* → Claude returns a curated tracklist with reasoning
...
**Example (Artists section):** *"The Weeknd appears across your short-term, 6-month, and all-time charts. That kind of consistency isn't habit — it's identity."*
